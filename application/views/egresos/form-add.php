	...
	<div class="col-md-4 col-md-offset-4" style="text-align:left">
		<div class="div-add-cliente">
			...
			<form role="form">
			  ...
			  <div class="form-group">
				<input type="text" id="egreso" class="form-control"  placeholder="$ Ingreso"/>
			  </div>
			  <div class="form-group">
			  ...
			  <input type="button" value="Agregar" class="btn btn-success" onclick="add_egreso('<? echo base_url() ?>egresos/add_egreso');">
			  <button type="submit" class="btn btn-warning">Cancelar</button>
			</form>
		</div>
		<div class="div-success">
			<p><img src="<? echo base_url() ?>public/images/Palomita.png"> Se agrego el Egreso correctamente</p>
