	...
	<div class="col-md-4 col-md-offset-4" style="text-align:left;">
		<div class="div-add-cliente">
			...
			<form role="form">
			  ...
			  <input type="button" value="Actualizar" class="btn btn-success" onclick="update_ingreso('<? echo base_url() ?>home/update_ingreso');">
			  <button type="submit" class="btn btn-warning">Cancelar</button>
			</form>
		</div>
		<div class="div-success">
			<p><img src="<? echo base_url() ?>public/images/Palomita.png"> Se actualizo el Ingreso correctamente</p>
			<center><input type="button" value="Ir a Registros" class="btn btn-info" onclick="ingresos();"></center>
			<br>
		</div>
	</div>
</div>